...
@frappe.whitelist()
def get_submitted_linked_docs(doctype, name, is_submittable=True, skip_doctypes=None, docs=None):
	"""
	...
	for link_doctype, link_names in linked_docs.items():
		for link in link_names:
			...
			validated_doc = validate_linked_doc(docinfo, is_submittable=is_submittable, skip_doctypes=skip_doctypes)
			...
			links = get_submitted_linked_docs(link_doctype, link.name, is_submittable=is_submittable, skip_doctypes=skip_doctypes, docs=docs)
			docs.append({
